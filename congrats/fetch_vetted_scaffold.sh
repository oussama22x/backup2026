...
VETTED_ID="a0a84e05-e560-4901-bfcb-a23ba70610e2"
VETTED_URL="https://lagvszfwsruniuinxdjb.supabase.co/rest/v1/audition_scaffolds?id=eq.$VETTED_ID&select=*"
...
echo "🚀 Fetching scaffold $VETTED_ID from VettedAI..."
