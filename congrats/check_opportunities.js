...
async function checkOpportunities() {
    console.log("🔍 Checking active opportunities...");

    // Fetch opportunities with a vetted_project_id
    const { data: opps, error } = await supabase
        .from('opportunities')
        .select('id, title, vetted_project_id')
    ...
    console.log(`Found ${opps.length} opportunities linked to VettedAI.`);
    opps.forEach(o => {
        console.log(`- Opp: "${o.title}" -> Project ID: ${o.vetted_project_id}`);
    });
}
