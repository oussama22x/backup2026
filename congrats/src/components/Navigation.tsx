...
import { LogOut, User, Briefcase, Building2, PencilLine, Check, LayoutDashboard } from "lucide-react";
...
export function Navigation() {
  ...
  const getNavItems = () => {
    ...
    switch (currentUser.role) {
      case "TALENT":
        return []; // Dashboard button is handled separately above
      case "RECRUITER":
        return [{
          label: "Cockpit",
          path: "/recruiter",
    ...
    ease: [0.22, 1, 0.36, 1]
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          />
          <span className="text-lg font-semibold tracking-tight"><span className="text-primary">VettedAI</span></span>
        </Link>
        ...
        {currentUser && <div className="flex items-center gap-4">
            ...
            <div className="hidden items-center gap-1 sm:flex">
              {/* Dashboard Button for TALENT */}
              {currentUser.role === "TALENT" && (
                <Link to="/talent/dashboard">
                  <Button variant={isActive("/talent/dashboard") ? "default" : "ghost"} size="sm" className="gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64 bg-popover z-50">
                ...
                <div className="sm:hidden">
                  {currentUser.role === "TALENT" && (
                    <DropdownMenuItem asChild>
                      <Link to="/talent/dashboard" className="cursor-pointer">
