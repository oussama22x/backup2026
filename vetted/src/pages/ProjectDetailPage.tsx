...
import { ArrowLeft, Loader2, Brain, Zap, MessageSquare, Lightbulb, Heart, Scale, HelpCircle, Clock } from "lucide-react";
    ...
    <ProjectLayout>
      <TooltipProvider>
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-8">
              ...
              <CardHeader className="space-y-2 pb-4">
                <div className="flex items-start justify-between">
                  <div className="space-y-1">
                    ...
                    <CardDescription>
                      {Object.values(questionsByDimension).flat().length} carefully selected questions across {Object.keys(questionsByDimension).length} performance dimensions
                    </CardDescription>
                  </div>
                  {bankId && (
          ...
          <section>
            <ShortlistSection projectId={projectId!} />
          </section>
        </div>
      </TooltipProvider>
    </ProjectLayout>
